...
|---|---:|
| Financial reconciliation and control improvement | **$1.2M+** in overpayments resolved |
| AI-augmented analytics delivery | **50%** increase in delivery throughput |
| Reporting modernization | **40%** reduction in reporting cycle time |
| CI/CD adoption for analytics | **60%** increase in release frequency |
| Data quality and financial accuracy | **30%** improvement |
| Risk-based compliance analytics | **20%** reduction in policy violations and **35%** faster SLA resolution |
| Inclusive instructional leadership | **94%** pass rate for English Learner and Special Education students |
| STEM and college-readiness leadership | **80%** growth in dual-credit enrollment over three years |
...
## Additional applied AI systems

### K–12 AI Tutoring & Governance Platform

Independent architecture for responsible AI-enabled learning, including role-based access, student-support workflows, instructional alignment, governance controls, and safe deployment patterns for K–12 environments.

### Higher Education AI Tutor

A retrieval-grounded tutoring system designed for Canvas LMS and gateway courses in mathematics, statistics, English composition, chemistry, and physics, with research-grounded writing guidance and citation-aware feedback.
...
- **Analytics Engineering Lead & Enterprise BI Platform Owner, SiloSmashers** — 2024–2026
- **Senior Data Analyst & BI Platform Lead, Mayvin** — 2022–2024
- **Adjunct Faculty, Anne Arundel Community College and Baltimore City Community College** — 2022–Present
- **Mathematics, Statistics & Data Analytics Professor** — Southern University and Arizona College of Nursing
- **Mathematics Department Chair & Analytics Leader, Gautier High School** — 2015–2019
- Earlier experience across federal data operations, business information analysis, education technology, and operations leadership

---

## Education and credentials

- **DBA, Artificial Intelligence & Machine Learning Leadership** — Walsh College, in progress; expected 2029
- **M.S., Data Analytics** — Eastern University, 2025
- **MBA, Organizational Management** — Eastern University, 2025
- **M.Ed., Mathematics** — William Carey University, 2015
- **B.S., Secondary Education (Mathematics)** — Mississippi State University, 2014
- **Maryland Advanced Professional License** · **Lean Six Sigma Yellow Belt** · **PMP in progress**
